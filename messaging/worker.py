...
async def worker():
    ...
    # Exchanges
    exchanges=[
        {'name':'analytics.service.exchange','exc_type':ExchangeType.DIRECT},
        {'name':'analytics.producer.exchange','exc_type':ExchangeType.DIRECT},
    ]
    ...
    # Queues
    queues=[
        {'exc_name':'analytics.service.exchange','q_name':'analytics.service.queue','r_key':'analytics.service.routing.key'},
        {'exc_name':'analytics.producer.exchange','q_name':'analytics.producer.queue','r_key':'analytics.producer.routing.key'}
    ]
    ...
    # Consumers
    consumers=[
        {'q_name':'analytics.service.queue','handler':service_main_controller},
        {'q_name':'analytics.producer.queue','handler':producer_main_controller}
    ]
